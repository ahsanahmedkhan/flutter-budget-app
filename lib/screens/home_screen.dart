...
import 'package:flutter_budget_app/helpers/color_helper.dart';
import 'package:flutter_budget_app/models/category_model.dart';
import 'package:flutter_budget_app/models/expense_model.dart';
import 'package:flutter_budget_app/screens/category_screen.dart';
          ...
          SliverList(
              delegate: SliverChildBuilderDelegate(
                  (BuildContext context, int index ){
                    if(index == 0) {
                      return Container(
                        margin: EdgeInsets.fromLTRB(20.0, 20.0, 2.0, 10.0),
                        decoration: BoxDecoration(
                          color: Colors.white,
                          boxShadow: [
                            BoxShadow(
